...
PRO truecolor_img_allfire, red=red, green=green, blue=blue, $
...
; MODIFIED BY BRUCE. (03/22/2012)
 ...
 ; redraw the map with noerase opition
   ...
   map_continents, /hires, /usa, mlinethick = 3, color=3
...
; plot fire hot spots
  if (keyword_set(firelat) and keyword_set(firelon)) then begin
     result = where(firelon ge region (1) and firelat ge region(0) and $
      ...
      print, 'total fire num in Selected Region: bruce',count 
