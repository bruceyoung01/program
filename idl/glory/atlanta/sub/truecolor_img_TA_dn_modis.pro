;  $ID: truecolor_img_TA_dn_modis.pro V01 06/08/2012 22:44 BRUCE EXP$
;
;******************************************************************************
;  PROCEDURE truecolor_img_TA_dn_modis PLOTS MODIS TRUE COLOR IMAGE, INCLUDING 
;  TERRA AND AQUA, WITH FIRE COUNTS(DAYTIME AND NIGHTTIME), ALSO OUTPUT FIRE 
;  COUNTS FILE.
;
;  VARIABLES:
;  ============================================================================
