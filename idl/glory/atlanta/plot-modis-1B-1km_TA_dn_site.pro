;******************************************************************************
; $ID: plot-modis-1B-1km_TA_dn_site.pro V01 03/27/2012 17:20 BRUCE EXP$
;
;******************************************************************************
;  PROGRAM plot-modis-1B-1km_TA_dn_site PLOTS MODIS TRUE COLOR IMAGE WITH 
...
@./sub/truecolor_img_TA_dn_modis_site.pro
@./sub/process_day_mod021km.pro

 ; decode filename list
 !p.font      = 6
 filedir      = '/home/bruce/sshfs/tw/parallel/data/satellite/modis/atlanta/mod021/'
 infile       = '2012mod021km_day'
 dfirefiledir = '/home/bruce/sshfs/tw/parallel/data/satellite/modis/atlanta/mod14/'
 dfirefilelist= '2012mod14_daynn'
 nfirefiledir = '/home/bruce/sshfs/tw/parallel/data/satellite/modis/atlanta/mod14/'
 nfirefilelist= '2012mod14_nightnn'
...
; region = [ 20, -100, 45, -70] ;ATLANTA_LARGE
  region = [ 32,  -86, 35, -82] ;ATLANTA_SMALL
 winx = 1000
 winy = 800
...
;   endelse
   ...
   truecolor_img_TA_dn_modis_site,                              $
              ...
              '_terra_dn_MODIS', latdel = 0.5, londel = 0.5,    $
              dlun = dlun, nlun = nlun
 endfor 
 FREE_LUN, dlun
 FREE_LUN, nlun
