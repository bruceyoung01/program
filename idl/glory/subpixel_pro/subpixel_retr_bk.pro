...
;level 1B radiance
rad_dir = '/research/wang/ljudd/rad/AQUA/'

;fire product
fire_dir = '/research/wang/ljudd/fp/AQUA/'

;geolocation
geo_dir = '/research/wang/ljudd/geo/AQUA/'

;water vapor
wv_dir='/research/wang/ljudd/wv/AQUA/'
...
;get filenames
openr,1, rad_dir + 'filenames.txt'
readf,1,rad_fname
close,1

openr,1, fire_dir + 'filenames.txt'
readf,1, fire_fname
close,1

openr,1, geo_dir + 'filenames.txt'
readf,1, geo_fname
close,1

openr,1, wv_dir + 'filenames.txt'
readf,1, wv_fname
close,1
...
;get MODIS GEOLOCATION DATA
	...
	filename = 'MOD03.A2002177.1825.005.2008235200145.hdf'
