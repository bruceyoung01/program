...
@/home/bruce/program/idl/modis/code/ne/sub/process_day_mod021km.pro

 ; decode filename list
 !p.font      = 6
 filedir      = '/home/bruce/sshfs/shw/data/satellite/MODIS/ne/myd021km/'
 infile       = '2011myd021km'
 firefiledir  = '/home/bruce/sshfs/shw/data/satellite/MODIS/ne/myd14/'
 firefilelist = '2011myd14'
...
;   endelse
   ...
   truecolor_img, red=red, green=green, blue=blue, $
              flat = flat, flon= flon, mag = 3, $
              region = region, winx=winx, winy=winy, $
              latdel = 5.0, londel = 5.0, outputname =  $
