; $ID: plot-modis-1B-1km_flambe_hour.pro V01 03/23/2012 10:29 BRUCE EXP$
;
;******************************************************************************
;  PROGRAM plot-modis-1B-1km_flambe_hour PLOTS MODIS TRUE COLOR IMAGE OVERLAID 
;  WITH FIRE LOCATION FROM FLAMBE FIRE EMISSION IN EACH HOUR.
;
;  VARIABLES:
;  ============================================================================
;  (1 )
...
@/home/bruce/program/idl/modis/code/flambe_modis/read_flambe_hour.pro
...
; READ LATITUDE, LONGITUDE OF FIRE DOTS FROM FLAMBE EMISSION
  ...
  FOR J = 1, 24 DO BEGIN
   firelat = FLTARR(NMAX)
   firelon = FLTARR(NMAX)
   READ_FLAMBE_HOUR, FIREFILEDIR, FIREFILELIST,               $
                     YEAR = IYEAR, MONTH = IMONTH, DAY = IDAY,$
                     HOUR = J, SATELLITE = SATELLITE,         $
