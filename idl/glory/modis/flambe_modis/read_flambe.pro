; $ID: read_flambe.pro V01 03/22/2012 10:04 BRUCE EXP$
;
;******************************************************************************
;  PROCEDURE read_flambe READS THE FIRE INFO FROM FLAMBE FIRE EMISSION DATA 
;  WITH DIFFERENT SATELLITE SOURCES. INFO INCLUDES LATITUDE, LONGITUDE, AND 
;  SATELLITE CODE.
...
PRO READ_FLAMBE, FILEDIR, FILELIST, YEAR = YEAR, $
                 MONTH = MONTH, DAY = DAY,       $
                 SATELLITE = SATELLITE,          $
                 FIRELAT = FIRELAT,              $
                 FIRELON = FIRELON
