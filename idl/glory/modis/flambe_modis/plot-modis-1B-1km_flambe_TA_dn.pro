; $ID: plot-modis-1B-1km_flambe_TA_dn.pro V01 03/27/2012 16:23 BRUCE EXP$
;
;******************************************************************************
;  PROGRAM plot-modis-1B-1km_flambe_TA_dn PLOTS MODIS TRUE COLOR IMAGE OVERLAID 
;  WITH FIRE LOCATION FROM FLAMBE FIRE EMISSION WITH DAY TIME AND NIGHT TIME 
;  SEPARATELY.
;
;  VARIABLES:
;  ============================================================================
...
;  (2 ) MODIFIED FROM plot-modis-1B-1km_flambe.pro. (03/27/2012)
;******************************************************************************


;  CALL SUBROUTINES
@/home/bruce/idl/IDLLIB/my-lib/mod1B/truecolor_img_TA_dn.pro
@/home/bruce/program/idl/modis/code/flambe_modis/read_flambe_TA_dn.pro
...
; READ LATITUDE, LONGITUDE OF FIRE DOTS FROM FLAMBE EMISSION
  ...
  READ_FLAMBE_TA_DN, FIREFILEDIR, FIREFILELIST,                   $
...
;   endelse
   ...
   truecolor_img_TA_dn, red=red, green=green, blue=blue, $
              ...
              outputname =  $
              sate1 + string(year(i), format='(I4)') + '_' + Dayname(i) + $
              ...
              DAFIRELAT = DAFIRELAT, DAFIRELON = DAFIRELON,$
              NAFIRELAT = NAFIRELAT, NAFIRELON = NAFIRELON,$
              title=sate1+string(year(i), format='(I4)') + Dayname(i) + $
              '_' + TimeS(i) + '_' + TimeE(i) + '_ALL_dn' 
 endfor 
 end
