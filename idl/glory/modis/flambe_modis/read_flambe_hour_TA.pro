; $ID: read_flambe_hour_TA.pro V01 03/26/2012 09:14 BRUCE EXP$
;
;******************************************************************************
;  PROCEDURE read_flambe_hour READS THE FIRE INFO FROM FLAMBE FIRE EMISSION 
;  DATA WITH BOTH SATELLITE SOURCES (TERRA AND AQUA). INFO INCLUDES 
;  LATITUDE, LONGITUDE, AND SATELLITE CODE.
...
PRO READ_FLAMBE_HOUR_TA, FILEDIR, FILELIST, YEAR = YEAR,     $
...
;  SELECT THE SAME SATELLITE
    SIND  = WHERE(ASATELLITE EQ SATELLITE1 OR $
                  ASATELLITE EQ SATELLITE2, NSIND)
