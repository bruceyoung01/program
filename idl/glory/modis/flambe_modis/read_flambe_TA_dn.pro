; $ID: read_flambe_TA_dn.pro V01 03/27/2012 16:33 BRUCE EXP$
;
;******************************************************************************
;  PROCEDURE read_flambe_TA_dn READS THE FIRE INFO FROM FLAMBE FIRE EMISSION 
...
;  (2 ) MODIFIED FROM read_flambe.pro. (03/27/2012)
;******************************************************************************

PRO READ_FLAMBE_TA_DN, FILEDIR, FILELIST, YEAR = YEAR,               $
                       MONTH = MONTH, DAY = DAY,                     $
