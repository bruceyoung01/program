...
HDFFileName(0)="./MYD04_L2.A2005200.1240.005.2006116001942.hdf"
...
title(0) = "Cloud_Mask_Summary_Flag"
QA_Byte(0) = 0
QA_Start_Bit(0) = 0
QA_Num_Bits(0) = 1
qanum(0) = 2
scalelabel(0,0) = "Undetermined (0)"
scalelabel(0,1) = "Determined (1)"

title(1) = "Cloud_Mask_Quality_Flag"
QA_Byte(1) = 0
QA_Start_Bit(1) = 1
QA_Num_Bits(1) = 3
qanum(1) = 4
scalelabel(1,0) = "Cloud Pixels: 0-30% (0)"
scalelabel(1,1) = "Cloud Pixels: 30-60% (1)"
scalelabel(1,2) = "Cloud Pixels: 60-90% (2)"
scalelabel(1,3) = "Cloud Pixels: >90% (3)"

title(2) = "Snow_Ice_Flag"
QA_Byte(2) = 0
QA_Start_Bit(2) = 4
QA_Num_Bits(2) = 1
qanum(2) = 2
scalelabel(2,0) = "Yes (0)"
scalelabel(2,1) = "No (1)"

title(3) = "Land_Sea_Flag"
QA_Byte(3) = 0
QA_Start_Bit(3) = 5
QA_Num_Bits(3) = 3
qanum(3) = 4
scalelabel(3,0) = "Water (Ocean or Lake) (0)"
scalelabel(3,1) = "Coastal (1)"
scalelabel(3,2) = "Desert (2)"
scalelabel(3,3) = "Land (3)"
