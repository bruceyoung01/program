...
title(0) = "Best_Usefulness_Ocean_QA"
QA_Byte(0) = 0
QA_Start_Bit(0) = 0
QA_Num_Bits(0) = 1
qanum(0) = 2
...
title(1) = "Best_Confidence_Ocean_QA"
QA_Byte(1) = 0
QA_Start_Bit(1) = 1
QA_Num_Bits(1) = 3
qanum(1) = 4
...
title(2) = "Average_Usefulness_Ocean_QA"
QA_Byte(2) = 0
QA_Start_Bit(2) = 4
QA_Num_Bits(2) = 1
qanum(2) = 2
...
title(3) = "Average_Confidence_Ocean_QA"
QA_Byte(3) = 0
QA_Start_Bit(3) = 5
QA_Num_Bits(3) = 3
qanum(3) = 4
...
title(4) = "Inversion_Not_Performed_Ocean_QA"
QA_Byte(4) = 1
QA_Start_Bit(4) = 0
QA_Num_Bits(4) = 4
qanum(4) = 11
scalelabel(4,0) = "Retreival is performed (0)"
scalelabel(4,1) = "Glitter is present (1)"
scalelabel(4,2) = "Cloudy (2)"
scalelabel(4,3) = "R (0.865um) too low (3)"
scalelabel(4,4) = "# VIS/SWIR (0.55um-1.2um) < 3 (4)"
scalelabel(4,5) = "# total channels < 3 (5)"
scalelabel(4,6) = "Angles out of bounds (6)"
scalelabel(4,7) = "Land present in 10 x 10 km (7)"
scalelabel(4,8) = "AOD (0.55um) < -0.01 (8)"
scalelabel(4,9) = "AOD (0.55um) > 5.0 (9)"
scalelabel(4,10) = "All channels do not have valid data (10)"

title(5) = "Inversion_Performed_Ocean_QA"
QA_Byte(5) = 1
QA_Start_Bit(5) = 4
QA_Num_Bits(5) = 4
qanum(5) = 16
scalelabel(5,0) = "Retreival performed normally (0)"
scalelabel(5,1) = "# useful pixels in 10x10 < 20% (1)"
scalelabel(5,2) = "R (0.865um) low; retrieve AOD but not FMW (2)"
scalelabel(5,3) = "SWIR 1.64um channel not used (3)"
scalelabel(5,4) = "SWIR 2.13um channel not used (4)"
scalelabel(5,5) = "Both 1.64 and 2.13um channels not used (5)"
scalelabel(5,6) = "Aerosol AOD and type are both unstable (6)"
scalelabel(5,7) = "Aerosol AOD is unstable but spectrally stable (7)"
scalelabel(5,8) = "The best value of error > 3% threshold (8)"
scalelabel(5,9) = "AOD (0.55um) < 0.0 (9)"
scalelabel(5,10) = "Glint angle between 30 and 40 (10)"
scalelabel(5,11) = "Glint: store only Refl, SD and # pixels (11)"
scalelabel(5,12) = "Glint: Thick dust retrieval (12)"
scalelabel(5,13) = "Possible cirrus contamination (13)"
scalelabel(5,14) = "Off glint thick dust retrieval (14)"
scalelabel(5,15) = "No retrieval (15)"
