...
;  AOD DATA (TERRA OR AQUA)
   filedir    = '/home/bruce/sshfs/pfw/data/satellite/MODIS/ne/myd04/'
   filedirres = '/home/bruce/program/idl/modis/code/aod/'
   filelist   = 'myd04_list'
;  LOAD COLOR TABLE
...
;                  ;TEXAS    ; WA     ; SAHEL   GLOBAL
   ...
   minlat = 25.0   ;25.0     ; 30.0   ;-10.0    -90.0
   maxlon =-90.0   ;-90.0    ;-110.0  ; 45.0    180.0
   minlon =-115.0  ;-115.0   ;-130.0  ;-25.0   -180.0 
...
;  PLOT THE AOD GRID ONTO MAP
    ...
    TVMAP, transpose(aaod), /grid,$
           ...
           title = 'AOD(Aqua) 2011 '+STRMID(dayname(j),0,4),        $
