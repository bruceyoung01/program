...
;  SET UP WORKSTATION
   SET_PLOT, 'PS'
   DEVICE, file='plot_wrf_tau.ps', xsize = 7, ysize= 10, $
...
;  READ OUT LATITUDE, LONGITUDE, PM2.5, AND AOD
    ...
    ncdfread, nc_file, 'TAUAER1',aod,aod_dim  
...
;  CALL SUBROUTINE plot_wrf_contour TO PLOT CONTOUR
    plot_wrf_contour, taod, llat, llon, minaod = minval, maxaod = maxval, $
                      region_limit = region, title = date, unit = ' '
