pro read_hdf_L1, path, FNAME, num, lat, lon, alt, tbks, ttmp, pratio, datetimeproduction    ;DPC RELEASE VERSION 3.2
;
...
; output the number of pixels, latitude and longitude, altitude, Total_Attenuated_Backscatter_532
num  = L1_NUM_RECS
lat  = L1_LAT
lon  = L1_LON
alt  = L1_LID_ALTS
