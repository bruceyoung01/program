...
@./sub/process_day.pro
  ...
  filedir = '/media/disk/data/calipso/2008/CAL_LID_L1-ValStage1-V3-01/ca/'
  filename1 = 'CAL_LID_L1-ValStage1-V3-01.2008-05-08T08-18-52ZN.hdf'
  fileres = '/media/disk/data/calipso/2008/CAL_LID_L1-ValStage1-V3-01/ca/'
  ...
  ;read_hdf_l1, filedir, filename(k), num, lat, lon, alt, tbks, ttmp, pratio, datetime
   read_hdf_l1, filedir, filename1, num, lat, lon, alt, tbks, ttmp, pratio, datetime
...
; title
; time
  title = STRMID(filename1, 0, 48)
  time  = STRMID(filename1, 27, 19)
