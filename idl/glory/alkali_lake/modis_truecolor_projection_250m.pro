...
filename = 'MOD02QKM.A2007145.1635.005.2007151023033.hdf'
...
; write the image into tiff , note Aqua images need reverse
   ...
   write_tiff, 'overlay-new250.tif', red=reverse(reverse(red,2),1), $
...
overlay, red, green, blue, flat, flon, np, nl, filename, 'overlay250.ps' 
