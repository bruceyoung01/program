...
plots, [-103, -100], [32, 32], color = 0, thick=6, linestyle=2   
...
red   = [0,    0, 255, 255,    255,  153, 76 , 0 , 180]
green = [0,  228, 255, 126,      0,    0,  0 , 0 , 180]
blue  = [0,    0,   0,   0,      0,   76, 38 , 255, 180]
...
set_plot,'ps'
device,filename='texas_station.ps',/portrait,xsize=6, ysize=8,$
...
; set title
outtitle = 'PM2.5 Station in Texas ' 
...
; if ( flon(ik) gt -96 ) then $ 
  plots, flon, flat, psym=sym(1, 1), color=0, symsize=1.5
;endfor


; plot map
map_set, 0, xcenter, $
/grid, charsize=1, mlinethick = 1, color=8,con_color=15,$ 
