...
Pro plot_daily_epa, day, time, monchar

; set output device and filenname
set_plot,'ps'
device,filename='daily_southern_us.ps',/portrait,xsize=6, ysize=8,$
...
time =17 
monchar = 'Apr'
plot_daily_epa, day, time, monchar
