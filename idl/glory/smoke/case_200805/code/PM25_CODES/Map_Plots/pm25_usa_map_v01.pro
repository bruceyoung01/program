...
; specify date
   ...
   ttime = 2100
   stime ='21:00'
   outfilename = 'us_map_May08_2008pm25'

;  open plot device

   SET_PLOT, 'PS' 
   DEVICE, file = outfilename+'_'+stime+'.ps', xsize = 6, ysize =4,$
              /inches, /color, BITS=8
...
;   map_range = [25,-130,50,-70]
   ...
   ; bar_labelv      = fltarr(7)
    ...
    ENDFOR
   XYOUTS, 95,-10, '!3PM2.5 Mass Concentration (!4l!3m!u-3!n)', color = 1
;  plot the color bar
   COLORBAR, NCOLORS=80, BOTTOM=20, DIVISIONS=5, TICKNAMES=[bar_labelv], color = 1,$
   POSITION=[0.15, 0.1, 0.85, 0.15]
