...
; procedure for plotting flames emission data
 pro plot_emission_subroutine_smoke_grid, lat1, lon1, flux, stime, date
...
; maximum of color
   ...
   for i = 0L, count-1 do begin
    if ( lon1(result(i)) gt xl and lon1(result(i)) lt xr and $
      ...
      plots, lon1(result(i)), lat1(result(i)), symsize=0.85, $
 ...
 ; set legend
    ...
    for i = 0, n_levels-1  do begin
     ...
     xyouts, 0.25, 0.84, ' SMOKE Emission ' + date, /normal,charsize=1.4,color=16,charthick=3
