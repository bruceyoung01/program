...
@./color_contour.pro
@./set_legend.pro
@./plot_emission_subroutine_case.pro
...
;  dir = '/home/bruce/data/smoke/smoke_goes2005/smoke_goes_2005_monthly/'
  ...
  filename1 = dir + 'monthly_emission_20030420_0521_lat'
  filename2 = dir + 'monthly_emission_20030420_0521_lon'
  filename3 = dir + 'monthly_emission_20030420_0521_emission'
  ...
  set_plot, 'ps'
  device, filename ='plot_emission_monthly_20030420_0521_23_hours_V2' + '.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

;  if ( strmid(stime,8,2)  eq '18' or  strmid(stime,8,2) eq '18'  ) then begin

  plot_emission_subroutine_case, lat, lon, emission/(1e6), stime
