...
@/home/bruce/program/idl/smoke/plot_emission_subroutine_smoke_grid.pro
@./color_contour.pro
@./set_legend.pro

  filedir    = '/home/bruce/data/smoke/nei_05/area4k_plus08/HR24/'
...
; calculate the difference between with emission data and without emission data
  ...
  SET_PLOT, 'ps'
  DEVICE, filename ='plot_' + output + 'D.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8
    
  plot_emission_subroutine_smoke_grid, lat, lon, pm25d, stime, output
