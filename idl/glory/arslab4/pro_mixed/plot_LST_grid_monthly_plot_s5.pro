...
@/home/bruce/program/idl/arslab4/plot_emission_subroutine_LST_grid_monthly_plot.pro
  ...
  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/2003/aodlst/'
  filelist = '200304as5lstlist_fire'
  date     = '200304as5lst_fire'
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + 's5_fire.ps', /portrait, xsize = 7.5, ysize=9, $
