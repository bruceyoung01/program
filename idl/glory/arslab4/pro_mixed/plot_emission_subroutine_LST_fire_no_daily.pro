...
; procedure for plotting flames emission data
 pro plot_emission_subroutine_LST_fire_no_daily, lat1, lon1, maxlat, minlat, maxlon, minlon, flux, date
...
; if the value of flux is larger than the maximum of color
 ...
 ; set legend
    ...
    for i = 0, n_levels-1  do begin
     ...
     xyouts, 0.12, 0.84, 'MODIS LST(no)-LST(no)  ' + date, /normal,charsize=1.4,color=16,charthick=3
