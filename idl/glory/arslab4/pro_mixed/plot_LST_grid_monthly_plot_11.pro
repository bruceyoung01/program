...
@/home/bruce/program/idl/arslab4/plot_emission_subroutine_LST_grid_monthly_plot_11.pro

  n = 21
  m = 175000L
  filedir  = '/home/bruce/data/modis/arslab4/results/2003/'
  filelist = '200304lstlist11'
  date     = '200304lst'    
  ...
  OPENW, lun, filedir + date + '11', /get_lun
  ncount = INTARR(m)
  tmean  = FLTARR(m)
  FOR j = 0L, m-1L DO BEGIN
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_200304_lst_11.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

  plot_emission_subroutine_LST_grid_monthly_plot_11, lat, lon,  maxlat, minlat, maxlon, minlon, tmean, date
