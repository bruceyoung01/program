...
@/home/bruce/program/idl/arslab4/plot_emission_subroutine_LST_nofire_monthlyl_s.pro
  ...
  filedir  = '/home/bruce/data/modis/arslab4/results/2003/lst_aod_fire_l5/'
  filename = '200304anl5lst'
  filename1= '200304ans5lst' 
;  filelist    = 'slist'
...
;  ENDFOR
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + filename + '_dl_sv.ps', /portrait, xsize = 7.5, ysize=9, $
