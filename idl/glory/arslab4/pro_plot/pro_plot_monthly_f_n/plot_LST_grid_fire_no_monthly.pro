; purpose of this program : plot the LST difference between pixels with fire and without fire.
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly_AOD/plot_emission_subroutine_LST_fire_no_monthly.pro


  filedir  = '/home/bruce/data/modis/arslab4/results/2003/'
  filename = '200304lst_fireno'
  filename1= '200304lst' 
  filedirres= '/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly_f_n/plot/'
...
;  ENDFOR
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedirres + 'plot_' + filename + '_d.ps', /portrait, xsize = 7.5, ysize=9, $
