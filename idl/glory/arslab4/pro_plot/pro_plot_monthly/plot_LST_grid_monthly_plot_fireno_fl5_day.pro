...
; purpose of this program : calculate and plot the monthly average MODIS LST>315K with AOD>0.5 and fire
...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_fl5.pro
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + STRMID(date, 0, 13) + 'fl5_day.ps', /portrait, xsize = 7.5, ysize=9, $
