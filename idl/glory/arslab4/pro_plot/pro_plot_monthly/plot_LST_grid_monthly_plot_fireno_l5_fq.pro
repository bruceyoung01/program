...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/al5lst/2003/'
  filelist = '200304al5lstlist'
  date     = '200304al5lst'
  ...
  years = INDGEN(n) + 1
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + '_al5_fq.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  PLOT, [years(0),years(0)], [count(0),y_count(0)], color = 1, $
        ...
        thick = 45.0, $
        title = 'Pixel Frequency Total (LST>315K and AOD>0.5)' + STRMID(date, 0, 6)
