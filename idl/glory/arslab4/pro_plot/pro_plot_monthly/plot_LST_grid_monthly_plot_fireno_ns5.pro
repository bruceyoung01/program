...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_ns5.pro

  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/2003/'
  filelist = '200304ans5lstlist'
  date     = '200304ans5lst'    
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + 'ns5.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

  plot_emission_subroutine_LST_grid_monthly_plot_ns5, lat, lon,  maxlat, minlat, maxlon, minlon, tmean, date
