...
; procedure for plotting flames emission data
 pro plot_emission_subroutine_LST_grid_monthly_plot_ns5, lat1, lon1, maxlat, minlat, maxlon, minlon, flux, date
...
; maximum of color
 ...
 ; set legend
    ...
    for i = 0, n_levels-1  do begin
     ...
     xyouts, 0.17, 0.84, 'MODIS LST Without Fire (AOD<0.5)  ' + STRMID(date, 0, 6) + STRMID(date, 13, 2), $
                         /normal,charsize=1.4,color=16,charthick=3
