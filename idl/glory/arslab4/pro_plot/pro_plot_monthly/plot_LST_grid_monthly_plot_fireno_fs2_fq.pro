...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/afs2lst/2003/'
  ...
  years = INDGEN(n) + 1
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + '_afs2_fq.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  PLOT, [years(0),years(0)], [count(0),y_count(0)], color = 1, $
        ...
        yrange = [0, 150], yminor = 2, ytitle = 'Frequency', $
        thick = 45.0, $
        title = 'Pixel Frequency with fire (LST>315K and AOD<0.2)' + STRMID(date, 0, 6)
