...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_fs5.pro
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + 'fs5.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

  plot_emission_subroutine_LST_grid_monthly_plot_fs5, lat, lon,  maxlat, minlat, maxlon, minlon, tmean, date
