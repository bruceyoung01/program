...
; purpose of this program : calculate and plot the monthly average MODIS LST (including fire) with AOD>0.5

@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_l5.pro

  n = 14
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/2010/'
  filelist = '201004al5lstlist'
  date     = '201004al5lst'    
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + 'l5.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

  plot_emission_subroutine_LST_grid_monthly_plot_l5, lat, lon,  maxlat, minlat, maxlon, minlon, tmean, date
