...
; purpose of this program : calculate and plot the day with average MODIS LST>315K with AOD<0.2 and no fire
...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_ns2.pro
  ...
  TVMAP, transpose(grid_c), /grid,$
         ...
         title = 'Day With Fire Free LST>315K and AOD<0.2 ' + STRMID(date(0), 0, 6),$
