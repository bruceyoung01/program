...
; purpose of this program : calculate and plot the monthly average MODIS LST with AOD<0.2 and fire

@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_fs2.pro

  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/2003/'
  filelist = '200304afs2lstlist'
  date     = '200304afs2lst'
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + 'fs2.ps', /portrait, xsize = 7.5, ysize=9, $
          xoffset = 0.5, yoffset = 1, /inches, /color, bits=8

  plot_emission_subroutine_LST_grid_monthly_plot_fs2, lat, lon,  maxlat, minlat, maxlon, minlon, tmean, date
