...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  n = 30
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/anl5lst/2003/'
  ...
  years = INDGEN(n) + 1
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + '_anl5_fq.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  PLOT, [years(0),years(0)], [count(0),y_count(0)], color = 1, $
        ...
        yrange = [0, 300000], yminor = 2, ytitle = 'Frequency', $
        thick = 45.0, $
        title = 'Pixel Frequency without fire (LST>315K and AOD>0.5)' + STRMID(date, 0, 6)
