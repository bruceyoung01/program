...
; purpose of this program : calculate and plot the day with average MODIS LST>315K with AOD<0.5 and fire
...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_monthly/plot_emission_subroutine_LST_grid_monthly_plot_fs5.pro
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + STRMID(date, 0, 13) + 'fs5_day.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  TVMAP, transpose(grid_c), /grid,$
         ...
         title = 'Day With Fire LST>315K and AOD<0.5 ' + STRMID(date(0), 0, 6),$
