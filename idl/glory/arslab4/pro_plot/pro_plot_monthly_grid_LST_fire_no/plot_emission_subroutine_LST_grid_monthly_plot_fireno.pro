...
; procedure for plotting flames emission data
 pro plot_emission_subroutine_LST_grid_monthly_plot_fireno, lat1, lon1, maxlat, minlat, maxlon, minlon, flux, date
...
; maximum of color
 ...
 ; set legend
    ...
    for i = 0, n_levels-1  do begin
     ...
     xyouts, 0.35, 0.84, 'MODIS LST ' + date, /normal,charsize=1.4,color=16,charthick=3
