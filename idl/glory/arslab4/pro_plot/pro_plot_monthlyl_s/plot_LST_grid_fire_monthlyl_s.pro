; purpose of this program : LST difference AOD>0.5-AOD<0.2 of fire pixels


  filedir  = '/home/bruce/data/modis/arslab4/results/2003/'
  filename = '200304afl5lst'
  filename1= '200304afs2lst'
  filedirres  = '/home/bruce/data/modis/arslab4/results/plot/2003/'
...
;  MYCT, 63, ncolors = 101, /midc, /rev
  ...
  TVMAP, transpose(grid_lst), /grid,$
         ...
         title = 'Fire LST(AOD>0.5-AOD<0.2) ' + STRMID(filename(0), 0, 6),$
