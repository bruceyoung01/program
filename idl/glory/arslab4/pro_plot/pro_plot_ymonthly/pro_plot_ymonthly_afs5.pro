...
@/home/bruce/program/idl/arslab4/pro_plot/pro_plot_ymonthly/plot_emission_subroutine_LST_grid_monthly_plot.pro

  n = 11
  m = 7000
  filedir  = '/home/bruce/data/modis/arslab4/results/afs5lst/afs5lst_monthly/'
  filelist = '04afs5lstlist'
  date     = '04afs5lst'
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedir + 'plot_' + date + '_afs5.ps', /portrait, xsize = 7.5, ysize=9, $
