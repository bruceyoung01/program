...
; purpose of this program : calculate the MODIS LST difference between l5 and anl5
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedirres + 'plot_' + STRMID(date, 0, 13) + 's2_ans2m.ps', xsize = 7.5, ysize=9, $
  ...
  TVMAP, transpose(d_grid_lst), /grid,$
         ...
         title = 'MODIS LST Difference(Total-Fire Free) AOD<0.2 April (2000-2010)', $
