...
; purpose of this program : plot the relationship between Land Surface Temperature and fire number in 0.5*0.5 degree
  ...
  filedir1    = '/home/bruce/data/modis/arslab4/results/afl5lst/afl5lst_monthly/'
  filename    = '04anl5lst'
  filename1   = '04afl5lst'
  filedirres  = '/home/bruce/data/modis/arslab4/results/plot/1/'
...
;  ENDFOR
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedirres + 'plot_' + filename + '_firenum_bgm.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  COLORBAR, Position=[0.3, 0.1, 0.7, 0.12], Bottom=20, NColors=230, $
