...
;  ENDFOR
  ...
  SET_PLOT, 'ps'
  DEVICE, filename =filedirres + 'plot_' + filename + '_firenum_bgm_lst_fn_ca.ps', /portrait, xsize = 7.5, ysize=9, $
  ...
  PLOT, x, y, psym = sym(1), color = 1, symsize=0.01, $
        ...
        title = 'Background LST and fire number(AOD<0.2) April (2000-2010) CA', $
