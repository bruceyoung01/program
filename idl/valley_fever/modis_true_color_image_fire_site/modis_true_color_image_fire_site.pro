;******************************************************************************
; $ID: modis_true_color_image_fire_site.pro V01 03/27/2012 17:20 BRUCE EXP$
;
;******************************************************************************
;  PROGRAM modis_true_color_image_fire_site PLOTS MODIS TRUE COLOR IMAGE WITH 
;  FIRE DOTS, AND SITE LOCATION
;
;  VARIABLES:
;  ============================================================================
;  (1 )
...
@/Users/bruce/Documents/A/program/idl/idl_lib/procedure/universal/process_day_mod021km.pro
@/Users/bruce/Documents/A/program/idl/idl_lib/procedure/valley_fever/truecolor_img_TA_dn_modis_site.pro

 ; decode filename list
 !p.font      = 6
 filedir      = '/Volumes/TOSHIBA_3B/iproject/valley_fever/modis/mod021/'
 infile       = 'mod021_list'
 dfirefiledir = '/Volumes/TOSHIBA_3B/iproject/valley_fever/modis/mod14/'
 dfirefilelist= 'mod14_list_day'
 nfirefiledir = '/Volumes/TOSHIBA_3B/iproject/valley_fever/modis/mod14/'
 nfirefilelist= 'mod14_list_night'
 dcountfile   = 'Terra_fire_count_daytime_atlanta'
 ncountfile   = 'Terra_fire_count_nighttime_atlanta'
;tornadofile  = '~/PRO/Storm_data/May_tornado.txt'

; SITE LOCATION
  slat = [33.45, 34.05]
  slon = [-112.0667, -118.25]
...
;   endelse
   ...
   truecolor_img_TA_dn_modis_site,                              $
              ...
              '_terra_dn_MODIS', latdel = 5.0, londel = 5.0,    $
              dlun = dlun, nlun = nlun
 endfor 
 FREE_LUN, dlun
 FREE_LUN, nlun
