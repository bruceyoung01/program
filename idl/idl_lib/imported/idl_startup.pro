...
if ( !VERSION.RELEASE lt 6.2 ) then $
   !PATH   = Expand_Path( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/gamap2/', /All_Dirs ) + Sep + IdlPath
...
if ( !VERSION.RELEASE ge 6.2 ) then                             $
   Pref_Set, 'IDL_PATH',                                        $
            Expand_Path( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/gamap2/', /All_Dirs ) + Sep + $
            EXPAND_PATH( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/my-lib/', /All_Dirs ) + Sep + $
            EXPAND_PATH( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/mylib_09/', /All_Dirs ) + Sep + $
            EXPAND_PATH( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/gamap2/', /All_Dirs ) + Sep + $
            EXPAND_PATH( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/mylib_modis/', /All_Dirs ) + Sep + $
            EXPAND_PATH( '+~/Documents/A/program/idl/idl_lib/imported/nasa_lib/ncdf_quickwrite/' ) + Sep + $
            '<IDL_DEFAULT>', /Commit
