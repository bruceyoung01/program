; $Id: ctm_oxbudget.pro,v 1.2 2008/04/02 15:19:02 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        CTM_OXBUDGET
...
; or plesager@.harvard.edu with subject "IDL routine ctm_oxbudget"
;-----------------------------------------------------------------------
...
pro CTM_OxBudget, BatchFile, LogFileName=LogFileName
   ...
   ; NOTE: You can skip this if the box is the whole atmosphere
   ;====================================================================
   Global = 0L
   ...
   ;====================================================================
   if ( Global ) then begin
      NetGMolDay = OxEx.Net     + OxCh.Net - $
                   HNO3wd.Total - Total( DryDep[*].Total )
   endif else begin
      NetGMolDay = OxCh.Net - HNO3wd.Total - Total( DryDep[*].Total )
   endelse
