; $Id: screen2jpg.pro,v 1.1.1.1 2007/07/17 20:41:35 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        SCREEN2JPG
...
; or phs@io.as.harvard.edu with subject "IDL routine screen2jpg"
;-----------------------------------------------------------------------
...
pro Screen2JPG, FileName, ThisFrame=ThisFrame, _EXTRA=e
   ...
   case ( StrUpCase( StrTrim( !D.NAME, 2 ) ) ) of 
      ...
      'X': begin
         if ( Is_File )                                                      $
            then ThisFrame = TvRead( FileName=NewFileName, /JPEG, _EXTRA=e ) $
