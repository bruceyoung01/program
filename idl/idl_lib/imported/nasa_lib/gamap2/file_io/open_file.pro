; $Id: open_file.pro,v 1.2 2008/07/01 14:51:53 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        OPEN_FILE
...
; or phs@io.as.harvard.edu with subject "IDL routine open_file";
;-----------------------------------------------------------------------
...
pro open_file,filemask,lun,filename=filename,write=write, $
              ...
              Swap_Endian=Swap_endian, get_lun=get_lun, _EXTRA=e
