; $Id: read_bdt0001.pro,v 1.2 2008/04/02 15:19:02 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        READ_BDT0001
...
; or phs@io.as.harvard.edu with subject "IDL routine read_bdt0001"
;-----------------------------------------------------------------------
...
pro read_bdt0001,filename,data,vardesc,nvars,nlines,  $
    ...
    ; open the file for reading (big-endian)
