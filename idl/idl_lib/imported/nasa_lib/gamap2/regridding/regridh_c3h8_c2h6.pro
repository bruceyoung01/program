; $Id: regridh_c3h8_c2h6.pro,v 1.1.1.1 2007/07/17 20:41:32 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        REGRIDH_C3H8_C2H6
...
; with subject "IDL routine regridh_c3h8_c2h6"
;-----------------------------------------------------------------------


pro RegridH_C3H8_C2H6, InFileName=InFileName,     OutFileName=OutFileName,    $
   ...
   ; Keywords
   if ( N_Elements( DiagN         ) eq 0 ) then DiagN         = 'ANTHSRCE'
   ...
   if ( N_Elements( OutFileName ) ne 1 ) then begin
      OutFileName = 'C3H8_C2H6_ngas.geos.' + CTM_ResExt( OutTypeSav )
   endif
