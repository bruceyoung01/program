; $Id: regridh_porl.pro,v 1.1.1.1 2007/07/17 20:41:32 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        REGRIDH_PORL
...
; or phs@io.as.harvard.edu with subject "IDL routine regridh_porl"
;-----------------------------------------------------------------------
...
pro RegridH_PorL, InFileName=InFileName,     OutFileName=OutFileName,     $
   ...
   CTM_Get_Data, DataInfo, FileName=InFileName, /Quiet, _EXTRA=e
