...
;
;       Record length of database cannot exceed 32767 bytes
;
; SIDE EFFECTS:  
...
if totbytes GT 32767 then $
     message,'Error - total length of database ' + strtrim(totbytes,2) + $
              ' bytes exceeds maximum allowed of 32767 '  
