...
if not keyword_set(coloroption) then $
      coloroption =  -1 
...
if (coloroption eq -1) then $ 
colors =  [ 0,  -16,  4,  7,  12, 14,  17,  19,  21, 25, 29, 32, 35, 41, 47]+16

if (coloroption eq 1 ) then $ 
colors =  [ 0,    4,  7,  12, 14, 17,  19, -16,  -16, 25, 29, 32, 35, 41, 47]+16

if (coloroption eq 2 ) then $ 
colors =  [ 0,    4,  7,  -16,  -16, 14, 17,  19, 21, 25, 29, 32, 35, 41, 47]+16
