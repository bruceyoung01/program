...
PRO truecolor_ps_TA_dn_modis, $
 ...
 ;  map_grid, latdel = latdel, londel=londel, /box_axes
  ...
  xyouts, latlabs, lats, string(lats, format='(I3)'), color=1, align=0.5, charsize = 1.0
  xyouts, lons, lonlabs, string(lons, format='(I4)'), color=1, align=0.5, charsize = 1.0
...
; plot fire hot spots
  if (keyword_set(dtfirelat) and keyword_set(dtfirelon)) then begin
     dtresult = where(dtfirelon ge region (1) and dtfirelat ge region(0) and $
      ...
      print, 'total fire num (day) : ',dtcount 
  ...
  if (keyword_set(ntfirelat) and keyword_set(ntfirelon)) then begin
     ntresult = where(ntfirelon ge region (1) and ntfirelat ge region(0) and $
      ...
      print, 'total fire num (night) : ',ntcount
...
;      print, 'total fire num: bruce',dacount
...
;      print, 'total fire num: bruce',nacount
