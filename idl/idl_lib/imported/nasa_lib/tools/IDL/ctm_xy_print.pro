...
;
; EXAMPLE:
;        (1) Call CTM_XY_PRINT to print out tracers 6904 and 6906. 
;            
;           > ctm_xy_print, 'FD-TEST', tracer=[6904,6906],ilun=21, fname='fd_vs_adj.txt'
;
...
;        dkh               - modified CTM_DIFF to print out data instead of take 
;                            differences. 
;
...
;   endelse
   ...
   ;====================================================================
   ; dkh 
   Ind  = Where( Data1 ne 0.e0 )
   if ( Ind[0] ge 0 ) then begin
         
   writedata,fname,[transpose(Data1[Ind]),transpose(Data2[Ind])],header,title='test',delim=' '
