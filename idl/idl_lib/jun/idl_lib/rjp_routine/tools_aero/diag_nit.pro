  pro diag_nit, File=file, region=region, Saveout=saveout, $
      tau0=tau0, results=results

;+
; pro diag_nit, File=files, region=region, /Saveout
;-
...
;    N_NIT   = 57L ; Off
    ...
    End
      ...
      NITDRYDEP = total(Results.NITdf) * 1.e-9  ; Tg N/yr
    ...
    End
      ...
      NITWETDEP = total(Results.NITWETDLS_$ + Results.NITWETDCV_$) * 1.e-9 ; Tg N/yr

      TOTLOSS = NITDRYDEP + NITWETDEP
...
Jump1:
    ...
    Endfor
      ...
      NITBURD = total(Results.NIT[*,*,0:19]) * MW_N * 1.e-9
 ...
 print, ' Nitrate Dry deposition : ', NITDRYDEP, NITDRYDEP/TOTLOSS*100.
 print, ' Nitrate Wet deposition : ', NITWETDEP, NITWETDEP/TOTLOSS*100.
 print, ' '
 print, 'Burden, Tg N               '
 print, ' Nitrate                : ', NITBURD
 print, ' '
 print, 'Life time, days
 print, ' Nitrate                : ', NITBURD/(NITDRYDEP+NITWETDEP)*Nday
 print, ' '
 print, 'Loss frequency, /day       '
 print, ' Nitrate dry deposition : ', NITDRYDEP/NITBURD/Nday
 print, ' Nitrate wet scavenging : ', NITWETDEP/NITBURD/Nday
 print, '-----------------------------------------------------'

 If Keyword_set(Saveout) then begin

  Openw, Ilun, 'Diag_nit.txt', /Get
