  pro diag_phase, File=file, region=region, Saveout=saveout, $
...
;===============================================================================
    ...
    Tracers = [Tracers, Lindgen(2) + 7100L + N_SO2 + 7L]
    ...
    End
      ...
      ASO4DRYD  = total(Results.ECPIdf) * 1.e-9 
      CSO4DRYD  = total(Results.OCPIdf) * 1.e-9 

    ;3) WET deposition information
    ;           SO2    SO4    MSA
    Tracers = Lindgen(3) + 3300L + N_SO2
    Tracers = [Tracers, Lindgen(2) + 3300L + N_SO2 + 7L]
    ...
    End
      ...
      ASO4WETD  = total(Results.ECPIWETDLS_$ + Results.ECPIWETDCV_$) * 1.e-9 
      CSO4WETD  = total(Results.OCPIWETDLS_$ + Results.OCPIWETDCV_$) * 1.e-9 
    ...
    Case N_SO2 of 
        ...
        52 : Tracers = [6551L,6552L,6553L,6554L,6555L,6556L,6557L]   
    End
...
Jump1:
    ...
    TRACERS = [TRACERS, Lindgen(2) + N_SO2 + 7L]
    For ND = 0, N_elements(Tracers)-1 do begin
    ...
    Endfor
      ...
      AS4BURD = total(Results.ECPI[*,*,0:19]) * 32.e-12
      CS4BURD = total(Results.OCPI[*,*,0:19]) * 32.e-12
 ...
 print, ' SO2 biofuel use         : ', SO2SRC_bf, SO2SRC_bf/TOTEMS*100.
 ...
 print, ' ASO4 Dry deposition     : ', ASO4DRYD,  ASO4DRYD/TOTLOSS*100.
 print, ' ASO4 Wet deposition     : ', ASO4WETD,  ASO4WETD/TOTLOSS*100.
 print, ' CSO4 Dry deposition     : ', CSO4DRYD,  CSO4DRYD/TOTLOSS*100.
 print, ' CSO4 Wet deposition     : ', CSO4WETD,  CSO4WETD/TOTLOSS*100.
 ...
 print, ' ASO4                    : ', AS4BURD/(ASO4DRYD+ASO4WETD)*Nday
 print, ' CSO4                    : ', CS4BURD/(CSO4DRYD+CSO4WETD)*Nday
 print, ' '
