...
; part of a larger package, please contact the author to arrange 
; payment. Bugs and comments should be directed to bmy@io.harvard.edu
; with subject "IDL routine ctm_plot_timeseries".
;-----------------------------------------------------------------------
