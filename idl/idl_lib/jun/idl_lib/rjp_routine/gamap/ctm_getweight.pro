; $Id: ctm_getweight.pro,v 1.2 2004/06/03 17:58:07 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        CTM_GETWEIGHT
...
;        NewType = CTM_TYPE( 'GEOS1', RES=4 )
;        NewGrid = CTM_GRID( NewType, /No_Vertical )
;
;        CTM_GetWeights, OldGrid, NewGrid, Weight, XX_IND, YY_IND, $
...
; with subject "IDL routine ctm_getweight"
;-----------------------------------------------------------------------
