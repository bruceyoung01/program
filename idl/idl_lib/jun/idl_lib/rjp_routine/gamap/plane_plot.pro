; $Id: plane_plot.pro,v 1.1 2005/03/25 21:23:44 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        PLANE_PLOT
...
; with subject "IDL routine plane_plot"
;-----------------------------------------------------------------------
...
pro Plane_Plot, Var, FltId, $
   ...
   ; Make date string
   DateStr = String( PlaneFlight[0].Date, Format='(i8.8)' )
