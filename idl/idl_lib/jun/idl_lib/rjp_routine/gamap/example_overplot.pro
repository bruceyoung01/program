;-------------------------------------------------------------
; $Id: example_overplot.pro,v 1.1.1.1 2003/10/22 18:06:04 bmy Exp $
;+
; NAME:
;        EXAMPLE_OVERPLOT
;
...
; with subject "IDL routine example_overplot"
;-------------------------------------------------------------
...
; print,'## TRACER=',tracer
   ...
   ctm_get_data,datainfo,diagn,tracer=tracer,tau0=tau0
