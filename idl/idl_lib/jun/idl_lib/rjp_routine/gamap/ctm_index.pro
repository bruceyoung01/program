; $Id: ctm_index.pro,v 1.2 2004/03/26 17:02:24 bmy Exp $
;-------------------------------------------------------------
;+
; NAME:
;        CTM_INDEX
...
;
;        (4)
;        CTM_INDEX,CTM_TYPE('GISS_II'),I,J,edge=[-25.,170.,0.,-100.], $
...
; or bmy@io.harvard.edu with subject "IDL routine ctm_index"
;-------------------------------------------------------------
