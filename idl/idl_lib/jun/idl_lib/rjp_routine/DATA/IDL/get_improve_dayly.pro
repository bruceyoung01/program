...
;-----------------------------------------------------------------
 ...
 function recon_struct, data, date, lon
...
;============================================================================
 ...
 function get_improve_dayly

  files = collect('/users/ctm/rjp/Data/IMPROVE/Raw_data/DAILY_2001/*.txt')
  ...
  For D = 0, N_elements(files)-1 do begin
    ...
    out = recon_struct( data, date, lon )
    print, files[d]
