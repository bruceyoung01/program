; $Id: add_data.pro,v 1.1.1.1 2003/10/22 18:09:38 bmy Exp $
;-------------------------------------------------------------
;+
; NAME:
;        ADD_DATA
...
;
; EXAMPLE:
;        suppose DATA is a 3x10 array, and HEADER contains the names A, B, and C.
;        Then 
...
; with subject "IDL routine add_data"
;-------------------------------------------------------------
