; $Id: screen2tiff.pro,v 1.1.1.1 2003/10/22 18:09:38 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        SCREEN2TIFF
...
;             If not specified, SCREEN2TIFF will use "idl.jpg"
...
;        (2) SCREEN2TIFF is just a convenience wrapper for TVIMAGE.
;
; EXAMPLES:
;        (1) 
;        PLOT, X, Y
;        SCREEN2TIFF, 'myplot.jpg'
;
...
pro Screen2TIFF, FileName, ThisFrame=ThisFrame, _EXTRA=e
   ...
   case ( StrUpCase( StrTrim( !D.NAME, 2 ) ) ) of 
      ...
      'X': begin
         if ( Is_File )                                            $
            then ThisFrame = TvRead( FileName=NewFileName, /TIFF ) $
