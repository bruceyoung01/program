; $Id: format_inp.pro,v 1.1.1.1 2003/10/22 18:09:40 bmy Exp $
;-------------------------------------------------------------
;+
; NAME:
;        FORMAT_INP
...
;             number of lines to skip before variable names and delimiter
;             for variable names (defaults: 1, 3, and ' ')
;
;        LINE --> data line to be displayed (default=1)
;
;        SIMPLE --> assume no unit and scale factor line, and print
;             dummies instead. Will be automatically set if SKP2 is less 
;             than 2.
;
; OUTPUTS:
...
;
; EXAMPLE:
;        format_inp,'~/terra/chem1d/INPUT/test.inp',line=3
;
...
; with subject "IDL routine format_inp"
;-------------------------------------------------------------
