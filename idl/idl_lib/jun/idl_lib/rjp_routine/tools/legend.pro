; $Id: legend.pro,v 1.1.1.1 2003/10/22 18:09:36 bmy Exp $
;-------------------------------------------------------------
;+
; NAME:
;        LEGEND
...
;             all symbols are plotted in the same color. Default is black.
;
...
;   ; to the plot command and the same vector as PLOTPOSITION to legend.
;
...
; with subject "IDL routine legend"
;-------------------------------------------------------------
...
pro legend,halign=halign,valign=valign,width=width, $
        position=position,plotposition=plotposition, $
        symbol=symbol,psym=psym,symsize=symsize,color=color, $
        line=line,lcolor=lcolor,thick=thick, $
        label=label,title=title,textcolor=textcolor,  $
        charsize=charsize,spacing=spacing, $
        nlines=nlines,frame=frame,boxcolor=boxcolor, $
