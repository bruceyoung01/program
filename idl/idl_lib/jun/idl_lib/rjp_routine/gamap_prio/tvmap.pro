...
pro TVMap, Data, XArr, YArr,                                               $
   ...
   if ( CBar ) then begin
      ...
      XYOutS, XPos, YPos, CBUnit, /Normal, $
         Align=0.5, Color=MColor, CharSize=CsFac
   endelse
