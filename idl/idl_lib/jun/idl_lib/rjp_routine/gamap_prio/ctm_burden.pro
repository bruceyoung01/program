...
function CTM_Burden, DiagN,                                        $
   ...
   if ( GEOS and N_Elements( TropFileName ) gt 0 ) then begin
      ...
      for I = 0L, IMX - 1L do begin
         ...
         if ( L lt Trop[IREF, JREF] ) then begin
            ...
            ; Compute concentrations in the grid box [mol]
      ...
      for L = 0L, LMX - 1L do begin
         ...
         ; Compute concentration of tracer [mol]
         C[*, *, L]  = Data[*, *, L] * AD[*, *, L] / 6.022d23
      endfor
   ...
   C      = C / Volume ; Convert from mol to mol/m3
