...
for ic = 0, nsize-1 do begin

  p     = (press(ic) > 0.01) < 1013.25
  delta = p/1013.25
 ...
 alt(ic) = REARTH*h/(REARTH-h)      ; convert geopotential to geometric altitude
