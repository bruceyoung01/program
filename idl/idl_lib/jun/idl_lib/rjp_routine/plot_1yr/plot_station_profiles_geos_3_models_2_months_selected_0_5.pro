; $Id: plot_station_profiles_geos_3_models_2_months_selected_0_5.pro,v 1.1 2005/03/10 15:52:15 bmy Exp $
pro plot_station_profiles_geos_3_models_2_months_selected_0_5, $
        mon1, mon2, mon3, mon4,$
   ...
   ; NOTE: Now uses GET_SPECIES_GEOS and GET_PRESSURE_GEOS, which can
   ;       read both GEOS-3 and GEOS-4 met fields.  Also added comments.
   ;       (bmy, 3/7/05)
   ...
   for i=0,max_station-1 do begin
      ...
      ;=====================================================================
      name_sonde='/users/trop/iam/sondes.for.gmi/sonde'+num_station(i)+'.0.5'
      ...
      ;=====================================================================
      ; Read O3 from first model and first month
      ;=====================================================================
      ...
      ;=====================================================================
      ; Read O3 from first model and 4th month
      ;=====================================================================
      ...
      ;=====================================================================
      ; Read O3 from first model and 2nd month
      ;=====================================================================
      ...
      ; Plot 1st model
      oplot, mod3_p,-alog10(pressure3_p),linestyle=0,psym=4,$
         symsize=0.3,color=2 
      oplot, mod3_p,-alog10(pressure3_p),linestyle=0,color=2

      ; Plot 2nd model
      oplot, mod3_2_p,-alog10(pressure3_2_p),linestyle=0,psym=4,$
         symsize=0.3,color=3
      oplot, mod3_2_p,-alog10(pressure3_2_p),linestyle=0,color=3

      ; Plot 3rd model
      oplot, mod3_3_p,-alog10(pressure3_3_p),linestyle=0,psym=4,$
         symsize=0.3,color=4
      ...
      xyouts, 0.06, 0.70, 'Pressure (hPa)', /normal, align=0.5, $
