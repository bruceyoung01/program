pro plot_gridded_C3H8_vs_data_geos_3_models, Species, max_sta,$
...
scales=[200,200,200,200,200,200,250,100,1000,500,150,100,250,200,200,200,$
        400,200,100,100,100,100,100,100,200,300,100,250,500,250,250,50,50,$
        50,50,1000,500,500,200]
...
; Plot profile from geos model
   ...
   oplot,co*1000/3,-alog10(pressure),psym=-8, symsize=0.2,linestyle=1,color=2
...
; Plot profile from geos_2 model
   ...
   oplot,co*1000/3,-alog10(pressure),psym=-8, symsize=0.2,linestyle=2,color=3
...
; Plot profile from geos_3 model
   ...
   oplot,co*1000/3,-alog10(pressure),psym=-8, symsize=0.2,linestyle=3,color=4

; Put labels on the axes

;if ncount eq nrow*ncol then begin
xyouts, 0.05, 0.5, 'Pressure (hPa)', /normal, align=0.5, orientation=90, charsize=1.2,color=1
xyouts, 0.5, 0.05, 'C3H8 (ppt)', /normal, align=0.5, charsize=1.,color=1
;endif
