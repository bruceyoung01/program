; $Id: plot_gridded_CO_vs_data_geos_3_models.pro,v 1.2 2003/12/08 19:34:58 bmy Exp $
...
scales=[200,200,200,200,200,180,200,180,240,200,180,180,120,200,180,220,$
        180,200,180,500,200,120,120,120,180,120,120,150,200,120,180,200,$
        300,180,200,180,120,120,120,120,240,240,240,240]
...
; Plot profile from the first geos model
...
;   filef =  strtrim(name_sta(kk),2)+'.geos'
   ...
   pressure=fltarr(nalt2) ;geos
   co=fltarr(nalt2)       ;geos
