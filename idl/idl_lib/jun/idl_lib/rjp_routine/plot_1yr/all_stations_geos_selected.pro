; $Id: all_stations_geos_selected.pro,v 1.2 2003/12/08 19:34:52 bmy Exp $
pro all_stations_geos_selected, species1, species, max_sta, dir, pref, indyear,ptop,ext

filest='/users/trop/iam/netCDF/'+species1+'.stations.selected.1'
;PRINT, filest
