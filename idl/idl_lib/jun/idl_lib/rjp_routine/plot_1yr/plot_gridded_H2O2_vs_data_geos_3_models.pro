pro plot_gridded_H2O2_vs_data_geos_3_models, Species, max_sta,$
...
scales=[3,3,4,3,3,3,4,8,6,5,6,6,5,3,3,3,3,3,3,3,3,3,3,3,3,3,4,4,4,4]
...
xyouts, 0.5, 0.05, 'H2O2 (ppb)', /normal, align=0.5, charsize=1.,color=1
;endif
