pro plot_gridded_NO_vs_data_geos_3_models, Species, max_sta,$
              ext1, ext2, ext3, title, psname, nalt1, nalt2, nalt3

; For selected regions from aircraft compains plot data profiles (black
; solid line and profiles from 3 models - with geos and geos_2  
...
mmonth=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
 ...
 scales=[250,250,250,250,250,250,250,250,250,250,250,250,250,150,250,150,$
         350,250,250,500,350,350,350,500,500,250,150,250,250,250,250,250,$
         500,300,500,250,500,500,500,250,150,150,150,150,150,150,150,150]
...
; -- read geos files --
   ...
   A = fltarr(2)
   filef ='' 
   filef =  strtrim(name_sta(kk),2)+'.geos'
...
; Plot profile from geos model
   ...
   oplot,co*1000,-alog10(pressure),psym=-8, symsize=0.2,linestyle=1,color=2
...
; Plot profile from geos_2 model
   ...
   oplot,co*1000,-alog10(pressure),psym=-8, symsize=0.2,linestyle=2,color=3
...
; Plot profile from geos_3 model
   ...
   oplot,co*1000,-alog10(pressure),psym=-8, symsize=0.2,linestyle=3,color=4

; Put labels on the axes

;if ncount eq nrow*ncol then begin
xyouts, 0.05, 0.5, 'Pressure (hPa)', /normal, align=0.5, orientation=90, charsize=1.2,color=1
xyouts, 0.5, 0.05, 'NOx (ppt)', /normal, align=0.5, charsize=1.,color=1
;endif
