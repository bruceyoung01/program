pro plot_station_profiles_geos_3_models_2_months_selected_sonde, mon1, mon2, mon3, mon4,$
...
; Plot sonde data
  ...
  plot, sonde1_p, -alog10(pressure_sonde1_p), xstyle=1,ystyle=5,$
    ...
    xticks=8, min_val=-900, yrange=[-3,-alog10(70)], xrange=[loval,highval1],$
...
; Write the month on the plot
          ...
          xyouts,120,-alog10(90), month[mon1-1], charsize = 1, /data, color=1
...
; Plot sonde data
  ...
  plot, sonde3_p, -alog10(pressure_sonde3_p), xstyle=1,ystyle=5,$
    title=ltitle,linestyle=0,psym=-5,symsize=0.6, color=1,$
    xticks=8, min_val=-900, yrange=[-3,-alog10(70)], xrange=[loval,highval3],$
...
; Put error bars (one standard deviation) sonde data
      ...
      for w = 0, levs-1 do begin
          ...
          xyouts,120,-alog10(90), month[mon3-1], charsize = 1, /data, color=1
