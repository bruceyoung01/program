; $Id: plot_4lev_o3_geos_3_models.pro,v 1.2 2003/12/08 19:34:56 bmy Exp $
pro plot_4lev_o3_geos_3_models, pref1, ptop1, dlat1, dlon1, nalt1, $
...
; Now plot standard deviations
      ...
      oplot, findgen(12)+1,out[0:11,3],linestyle=1,color=2
      oplot, findgen(12)+1,out[0:11,3],linestyle=1,psym=-5,$
         symsize=0.6,color=2   

      oplot, findgen(12)+1,out2[0:11,3],linestyle=2,color=3
      oplot, findgen(12)+1,out2[0:11,3],linestyle=2,psym=-5,$
         symsize=0.6,color=3   

      oplot, findgen(12)+1,out3[0:11,3],linestyle=3,color=4
      oplot, findgen(12)+1,out3[0:11,3],linestyle=3,psym=-5,$
         symsize=0.6,color=4  

      xyouts,1,0.8*highval, '150 hPa', charsize = 1,color=1

      if ncount eq 1 or ncount eq 5 or ncount eq 9 or $
         ncount eq 13 or ncount eq 17 then begin  
