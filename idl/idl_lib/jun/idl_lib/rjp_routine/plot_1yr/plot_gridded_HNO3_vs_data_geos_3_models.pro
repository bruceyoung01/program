...
mmonth=['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec']
 ...
 scales=[1.5,2,1.5,1.5,2,3,1.5,1.5,1.5,1,1.5,1,1,1,1,1,$
         2,2,2,4,2.5,2.5,0.5,0.5,1,1,1,1,2,2,1,0.5,$
         0.5,0.5,0.5,2,2,2,1]
...
xyouts, 0.5, 0.05, 'HNO3 (ppb)', /normal, align=0.5, charsize=1.,color=1
;endif
