pro plot_gridded_PAN_vs_data_geos_3_models, Species, max_sta,$
...
scales=[1,1,1,1,1,1,1,1,1,0.5,1,1,0.5,0.5,0.5,0.5,$
        0.5,1,1,1,1.5,4,1,0.5,0.5,0.5,0.5,0.5,0.5,1,1,1,$
...
xyouts, 0.5, 0.05, 'PAN (ppb)', /normal, align=0.5, charsize=1.,color=1
;endif
