...
;=======================================================================
   ...
   ; choose all sites with longitude smaller then -130
    ...
    obs   = create_struct('SITEID', info.site_id[D],           $ 
                          'NAME',   info.station[D],           $
                          'STATE',  info.state[D],             $
   ...
   ; CASTNET
;    m_s_dir = '/users/ctm/rjp/Asim/icartt/Run_v7-04-03/timeseries/out_trop/'
    m_s_dir = '/users/ctm/rjp/Asim/icartt/Run_v7-04-03_nofire/timeseries/out_wet/'
    odir    = './data_castnet/'
