...
;    diff = region_only(diff, region='UScont')
    ...
    plot_region, diff, limit=limit, title=title, /cbar, $
         divis=5, mindata=mindata, maxdata=maxdata, unit=unit , $
...
;=============================================================================
    ...
    m_s_dir = '/users/ctm/rjp/Asim/icartt/Run_v7-04-03/output/out_trop_nowet/'
    confiles0 = 'X'
    ...
    m_s_dir = '/users/ctm/rjp/Asim/icartt/Run_v7-04-03_nofire/output/out_nowet/'
    confiles1 = 'X'
  ...
  if !D.name eq 'PS' then $
    open_device, file='del_gas_wet.ps', /color, /ps, /landscape
    ...
    maxdata = 10.
    grim, spec, confiles0, confiles1, Nlayer, limit=limit, $
        mindata=mindata, maxdata=maxdata, unit=unit, /nogylabel
