...
; including my own routines --- JWANG
!PATH        = '~/atlanta/jun/idl_lib/:'           + $
               '~/atlanta/jun/idl_lib/my-lib/:'    + $
               '~/atlanta/jun/idl_lib/gamap/:'     + $
               '~/atlanta/jun/idl_lib/my-lib/readcol/:' + $
               '~/atlanta/jun/idl_lib/my-lib/fit/:'     + $
               '~/atlanta/jun/idl_lib/my-lib/mod1B/:'   + $
               '~/atlanta/jun/idl_lib/my-lib/mod14/:'   + $
               '~/atlanta/jun/idl_lib/my-lib/AERONET/:' + $
               '~/atlanta/jun/idl_lib/my-lib/netCDF/:'  + $
               '~/atlanta/jun/idl_lib/my-lib/coyote/:'  + $
               !PATH
...
if ( !VERSION.RELEASE ge 6.2 ) then                             $
   Pref_Set, 'IDL_PATH',                                        $
             Expand_Path( '+~/atlanta/jun/idl_lib/gamap/', /All_Dirs ) + Sep + $
             '<IDL_DEFAULT>', /Commit
...
;if ( MYCT_Exists eq 1) then !P.COLOR = !MYCT.BLACK
