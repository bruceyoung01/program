; $Id: sign.pro,v 1.1.1.1 2007/07/17 20:41:29 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;       SIGN
...
;-
; Copyright (C) 1986, Johns Hopkins University/Applied Physics 
...
; each copy made.  This routine is provided as is without any express 
; or implied warranties whatsoever.  Other limitations apply as 
; described in the file disclaimer.txt.
;-----------------------------------------------------------------------
