; $Id: arrowmap.pro,v 1.2 2008/03/24 14:51:19 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        ARROWMAP
...
; or phs@io.harvard.edu with subject "IDL routine arrowmap"
;-----------------------------------------------------------------------
...
pro ArrowMap, U, V, X, Y,                                   $
              ...
              OverPlot=OverPlot,     NoAdvance=NoAdvance,   $
              _EXTRA=e
   ...
   ;====================================================================
   ; Now only advance to the next frame if NOADVANCE=0
