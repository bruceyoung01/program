; $Id: jpeg2ps.pro,v 1.1.1.1 2007/07/17 20:41:35 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        JPEG2PS
...
; or phs@io.as.harvard.edu with subject "IDL routine jpeg2ps"
;-----------------------------------------------------------------------


pro Jpeg2Ps, FileName, $
   ...
   ; 
   ; Call READ_JPEG To read in the JPEG image
   ;====================================================================
   TVLct, R_Sav, G_Sav, B_Sav, /Get
 
   Read_JPEG, ThisFileName, Image, _EXTRA=e
