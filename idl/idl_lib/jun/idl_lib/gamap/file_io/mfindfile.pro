; $Id: mfindfile.pro,v 1.1.1.1 2007/07/17 20:41:38 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        MFINDFILE
...
; or phs@io.as.harvard.edu with subject "IDL routine mfindfile"
;-----------------------------------------------------------------------
...
function MFindFile, Mask, _EXTRA=e
   ...
   if ( Float( !VERSION.RELEASE ) ge 5.5 ) then begin
      ...
      Result = Call_Function( 'file_search', Mask, _EXTRA=e )
      return, Result
