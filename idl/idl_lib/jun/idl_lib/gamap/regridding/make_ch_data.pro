; $Id: make_ch_data.pro,v 1.1.1.1 2007/07/17 20:41:30 bmy Exp $
;-----------------------------------------------------------------------
;+
; NAME:
;        MAKE_CH_DATA
...
; or phs@io.as.harvard.edu with subject "IDL routine make_ch_met"
;-----------------------------------------------------------------------
...
pro Make_CH_Data
   ...
   ; Input directory (change as necessary)
   ;InDir  = '~/S/'
   InDir  = '~/archive/data/sulfate_sim_200210/1x1_geos/'
   ;InDir  = '~/archive/data/carbon_200411/1x1_geos/'
   ;InDir  = '~/archive/data/dust_200203/1x1_geos/'
   ;InDir  = '~/archive/data/EPA_NEI_200411/1x1_geos/'
   ;InDir  = '~/archive/data/biomass_200110/1x1_geos/'
   ;InDir  = '~tmf/avhrrlai_2000/1x1/'
   ;OutDir = '/data/ctm/GEOS_1x1/'
   OutDir  = '~/archive/data/sulfate_sim_200210/1x1_geos_ch/'
