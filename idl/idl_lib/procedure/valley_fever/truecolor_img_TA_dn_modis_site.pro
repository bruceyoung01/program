;******************************************************************************
;  $ID: truecolor_img_TA_dn_modis_site.pro V01 06/08/2012 22:44 BRUCE EXP$
;
;******************************************************************************
;  PROCEDURE truecolor_img_TA_dn_modis_site PLOTS MODIS TRUE COLOR IMAGE, 
;  INCLUDING TERRA AND AQUA, WITH FIRE COUNTS(DAYTIME AND NIGHTTIME), 
;  ALSO OUTPUT FIRE COUNTS FILE, AND SITE LOCATION
;
;  VARIABLES:
;  ============================================================================
;  (1 )
...
;******************************************************************************
   ...
   PRO truecolor_img_TA_dn_modis_site,              $
 ...
 ;  map_grid, latdel = latdel, londel=londel, /box_axes
  ...
  xyouts, latlabs, lats, string(lats, format='(I3)'), color=1, align=0.5, charsize = 5.0, charthick = 2.0
  xyouts, lons, lonlabs, string(lons, format='(I4)'), color=1, align=0.5, charsize = 5.0, charthick = 2.0

; MODIFIED BY BRUCE. (03/22/2012)
  MYCT, 33

; PLOT SITE LOCATION
  PLOTS, slon, slat, psym = sym(2), color = 96, symsize = 3
; plot fire hot spots
