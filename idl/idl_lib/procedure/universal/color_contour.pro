...
pro color_contour, rlat, rlon, var, geo,  maxvalue, minvalue, $
                  N_Levels , region, day, time, monchar, $
		  xa, dx, ddx, dddx, $
...
colors = [ 0, -16,   4,  7,  10, 13,  17,  18, 21, 25,  32,  34, 36, 39, 42, 45]+16
...
map_set, 0, (xl+xr)/2, londel=360,latdel=5,   /cont, /usa, /noerase,  $
        lonalign=10,glinethick=1, color = 16, con_color=16, $
...
plots, [-73-kkk*8, -73-kkk*8], [10, 45], linestyle=1, color=16,$
               thick=1
endfor
